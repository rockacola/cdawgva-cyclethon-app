...
const ANIME_PATTERNS: AnimePattern[] = [
  ...
  { id: 'akira', name: 'Akira', nameJp: 'AKIRA', pattern: /\b(Akira)\b/i },
  {
    id: 'angel-beats',
    name: 'Angel Beats',
    nameJp: 'Angel Beats!',
  ...
  { id: 'baccano', name: 'Baccano', nameJp: 'バッカーノ！', pattern: /\b(Baccano)\b/i },
  {
    id: 'banana-fish',
    name: 'Banana Fish',
    nameJp: 'BANANA FISH',
  ...
  { id: 'bang-dream', name: 'BanG Dream', nameJp: 'BanG Dream!', pattern: /\b(BanG\s+Dream)\b/i },
  {
    id: 'doupo-cangqiong',
  ...
  { id: 'beck', name: 'Beck', nameJp: 'BECK', pattern: /\b(Beck)\b/i },
  { id: 'berserk', name: 'Berserk', nameJp: 'ベルセルク', pattern: /\b(Berserk)\b/i },
  {
  ...
  { id: 'bleach', name: 'Bleach', nameJp: 'BLEACH', pattern: /\b(Bleach|tybw)\b/i },
  {
    id: 'boku-no-pico',
    name: 'Boku no Pico',
    nameJp: 'ぼくのぴこ',
  ...
  { id: 'chihayafuru', name: 'Chihayafuru', nameJp: 'ちはやふる', pattern: /\b(Chihayafuru)\b/i },
  { id: 'clannad', name: 'Clannad', nameJp: 'CLANNAD', pattern: /\b(Clannad)\b/i },
  {
    id: 'code-geass',
    name: 'Code Geass',
    nameJp: 'コードギアス 反逆のルルーシュ',
  ...
  { id: 'death-note', name: 'Death Note', nameJp: 'DEATH NOTE', pattern: /\b(Death\s+Note)\b/i },
  {
    id: 'death-parade',
    name: 'Death Parade',
    nameJp: 'デス・パレード',
  ...
  { id: 'durarara', name: 'Durarara', nameJp: 'デュラララ!!', pattern: /\b(Durarara)\b/i },
  {
    id: 'eden-of-the-east',
  ...
  { id: 'flcl', name: 'FLCL', nameJp: 'フリクリ', pattern: /\b(FLCL)\b/i },
  {
  ...
  { id: 'gintama', name: 'Gintama', nameJp: '銀魂', pattern: /\b(Gintama)\b/i },
  {
    id: 'girls-band-cry',
    name: 'Girls Band Cry',
    nameJp: 'ガールズバンドクライ',
  ...
  },
  {
    ...
    nameJp: 'HUNTER×HUNTER',
    pattern: /\b(Hunter\s+x\s+Hunter|hxh)\b/i,
  },
  { id: 'hyouka', name: 'Hyouka', nameJp: '氷菓', pattern: /\b(Hyouka)\b/i },
  {
  ...
  { id: 'k-on', name: 'K-ON', nameJp: 'けいおん！', pattern: /\b(k[-\s]?on|K-On)\b/i },
  {
    id: 'kimi-ni-todoke',
    name: 'Kimi ni Todoke',
    nameJp: '君に届け',
  ...
  { id: 'one-piece', name: 'One Piece', nameJp: 'ONE PIECE', pattern: /\b(One\s+Piece)\b/i },
  { id: 'overlord', name: 'Overlord', nameJp: 'オーバーロード', pattern: /\b(Overlord)\b/i },
  { id: 'paprika', name: 'Paprika', nameJp: 'パプリカ', pattern: /\b(Paprika)\b/i },
  {
  ...
  { id: 'phantom', name: 'Phantom', nameJp: 'Phantom', pattern: /\b(Phantom)\b/i },
  {
    id: 'ping-pong-the-animation',
    name: 'Ping Pong the Animation',
    nameJp: 'ピンポン THE ANIMATION',
    pattern: /\b(Ping\s+Pong\s+the\s+Animation)\b/i,
  },
  { id: 'planetes', name: 'Planetes', nameJp: 'プラネテス', pattern: /\b(Planetes)\b/i },
  {
    id: 'mononoke-hime',
  ...
  },
  {
    ...
    nameJp: 'serial experiments lain',
  ...
  { id: 'trigun', name: 'Trigun', nameJp: 'トライガン', pattern: /\b(Trigun)\b/i },
  {
    id: 'juuni-kokuki',
...
export function animeIdToName(id: string, locale: string = 'EN'): string {
  ...
  return locale === 'JP' && !!entry.nameJp ? entry.nameJp : entry.name;
}
